...
const Hero = () => {
  return (
    <section
      ...
      >
        <div className=' bg-amber-400 relative flex flex-col justify-center items-start w-full pt-28'>
...
{statistics.map((stat) =>(
  <div key={stat.label}>
    ...
    <p className='leading-7 font-sans text-gray-700'>{stat.label}</p>
        ...
        <div className='relative flex justify-between items-center bg-amber-300 items-center 
